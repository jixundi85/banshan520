import{u as D,s as E,r as n,j as e,g as C,S as U}from"./index-g7trER_V.js";import{B as M}from"./brain-8iV3BU7M.js";import{T as R}from"./target-Cq6CeV9_.js";import{L as Q}from"./lightbulb-BN4HjKg5.js";import{T as B}from"./trending-up-DS621Hht.js";import{S as K}from"./settings-D7g0jEkd.js";import{R as L}from"./refresh-cw-Cq_njKOK.js";import{C as P}from"./copy-DPRdOS9g.js";import{T as z}from"./thumbs-up-8jFmIuW3.js";import{T as F}from"./thumbs-down-DKiOe1ln.js";import{C as O}from"./chevron-right-BFhRYOG_.js";const j=[{id:"diagnosis",name:"AI诊断师",icon:M,color:"from-violet-500 to-purple-600",bgColor:"bg-violet-500/10",desc:"深度分析企业AI现状，生成个性化诊断报告",capabilities:["AI成熟度评估","差距分析","升级路线图"],prompt:"你是一位专业的AI转型顾问，擅长分析企业的AI应用现状和潜力。"},{id:"strategy",name:"战略规划师",icon:R,color:"from-cyan-500 to-blue-600",bgColor:"bg-cyan-500/10",desc:"制定AI驱动增长策略，优化商业模式",capabilities:["商业模式优化","增长策略","竞争分析"],prompt:"你是一位经验丰富的商业战略顾问，专注于AI时代的商业创新。"},{id:"creative",name:"创意顾问",icon:Q,color:"from-amber-500 to-orange-600",bgColor:"bg-amber-500/10",desc:"激发创意灵感，优化内容营销策略",capabilities:["创意头脑风暴","内容策略","爆款分析"],prompt:"你是一位资深创意顾问，精通AIGC内容创作和营销传播。"},{id:"ops",name:"运营专家",icon:B,color:"from-emerald-500 to-teal-600",bgColor:"bg-emerald-500/10",desc:"优化运营流程，提升团队协作效率",capabilities:["流程优化","团队管理","效率提升"],prompt:"你是一位卓越的运营管理专家，擅长流程优化和效率提升。"}],X={diagnosis:["分析我们公司目前的AI成熟度","我们和行业领先者差距在哪里？","制定3个月的AI升级计划"],strategy:["如何用AI提升电商转化率？","我们的商业模式有哪些AI升级机会？","分析竞品的AI布局策略"],creative:["帮我策划一个AI短剧营销方案","分析近期爆款内容的共同点","如何用AI提升内容产出效率？"],ops:["优化内容生产团队的工作流程","如何用AI降低运营成本？","建立AI辅助的协作机制"]},l={USER:"user",ASSISTANT:"assistant"};function te(){var w;D();const{showToast:v}=E(),p=n.useRef(null),b=n.useRef(null),[i,N]=n.useState("diagnosis"),[o,d]=n.useState([{id:1,type:l.ASSISTANT,role:"diagnosis",content:`您好！我是半山AIX的专业AI顾问。
...
请告诉我您想了解的具体问题，或者选择一个角色类型获得专业建议。`,timestamp:new Date}]),[r,x]=n.useState(""),[m,u]=n.useState(!1),[y,h]=n.useState(!1),[f,A]=n.useState(.7),t=j.find(s=>s.id===i),I=()=>{var s;(s=p.current)==null||s.scrollIntoView({behavior:"smooth"})};n.useEffect(()=>{I()},[o]);const g=async()=>{if(!r.trim()||m)return;const s={id:Date.now(),type:l.USER,content:r,timestamp:new Date};d(a=>[...a,s]),x(""),u(!0),setTimeout(()=>{const a=S(r,i),c={id:Date.now()+1,type:l.ASSISTANT,role:i,content:a,timestamp:new Date};d($=>[...$,c]),u(!1)},1500+Math.random()*1e3)},S=(s,a)=>({diagnosis:`根据您的问题，我来帮您分析：
**🔍 现状评估**
1. **技术基础** - 需要评估现有的数字化程度
2. **人员能力** - 团队对AI工具的熟悉程度
3. **业务场景** - 哪些环节适合引入AI
